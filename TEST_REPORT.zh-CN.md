...
| 本机自动测试 | **通过** — 38 个套件、818 项测试 |
| TypeScript 构建 | **通过** |
| npm 打包烟测 | **通过** — 179 个文件；压缩后 291.1 kB；解压后 1.2 MB |
...
网络错误、窄范围 Cloudflare managed challenge 识别、可由信号中止的终端提示、系统浏览器
